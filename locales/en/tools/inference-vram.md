...
<section class="s5-tool-method" aria-labelledby="s5-vram-method">
  ...
  <div class="s5-tool-method__body">
    ...
    <p class="s5-tool-method__notes"><strong>Llama 4 coverage.</strong> Scout (17B active/109B total, 16 experts, 10M context) and Maverick (17B active/400B total, 128 experts, 1M) are reviewed against Meta's model card but are not turned into presets: they are MoE models and current primary sources do not expose the complete geometry required by this formula without unpublished assumptions.</p>
