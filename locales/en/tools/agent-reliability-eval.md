...
<section class="s5-section"><div class="s5-section-head"><h2>Connect the trace to the evaluation system</h2></div><p>These reliability metrics are one layer of a broader evaluation system. The <a href="/en/temas/evaluacion-modelos/">AI model and system evaluation framework</a> explains how to combine deterministic checks, reference sets, human evaluation and production signals without collapsing quality into a single score.</p></section>
