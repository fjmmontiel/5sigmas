...
<section class="s5-home-cover">
  <div class="s5-home-cover__intro">
    ...
    <p>Each topic connects a short video, an interactive animation, a technical chapter and the original sources. Build intuition first. Then manipulate the mechanism, test its limits and go deeper into the evidence.</p>
    ...
    <div class="s5-learning-loop" role="list" aria-label="5sigmas learning method">
      <div class="s5-learning-loop__item" role="listitem">
        ...
        <span><strong>Watch</strong><small>Get oriented in 1–2 minutes</small></span>
      </div>
      <div class="s5-learning-loop__item" role="listitem">
        <span class="s5-learning-loop__n">02</span>
        <span><strong>Manipulate</strong><small>Change variables and test the mechanism</small></span>
      </div>
      <div class="s5-learning-loop__item" role="listitem">
        <span class="s5-learning-loop__n">03</span>
        <span><strong>Go deeper</strong><small>Chapter and primary sources</small></span>
      </div>
    </div>
  </div>
...
<section class="s5-entry-section" aria-labelledby="s5-entry-title">
  <div class="s5-section-head s5-section-head--compact">
    ...
    <a href="/en/tools/">Experiment with tools →</a>
  </div>
  <nav class="s5-entry-grid" aria-label="Ways to enter the English 5sigmas library">
    <a class="s5-entry" href="/en/visuales/">
      <div class="s5-entry__index">01</div>
      <div class="s5-entry__title">Watch</div>
      <div class="s5-entry__text">Videos and interactive visuals for understanding an idea before going into detail.</div>
    </a>
    ...
    <a class="s5-entry" href="/en/articulos-tecnicos/">
      ...
      <div class="s5-entry__text">Architecture, decisions and limits from real AI systems.</div>
    </a>
  </nav>
</section>
...
<section class="s5-section" aria-labelledby="s5-concepts-title-en">
  <div class="s5-section-head">
    <div>
      ...
      <p class="s5-section-head__copy">Direct answers to the ideas behind modern AI.</p>
    </div>
  ...
  <div class="s5-simple-list">
    <a class="s5-list-row" href="/en/temas/llms/">
      ...
      <span class="s5-list-row__desc">What they are, how they learn and how they generate text token by token.</span>
    ...
    <a class="s5-list-row" href="/en/temas/transformer/">
      ...
      <span class="s5-list-row__desc">Attention, representations and the architecture behind modern models.</span>
    ...
    <a class="s5-list-row" href="/en/temas/razonamiento/">
      ...
      <span class="s5-list-row__desc">What reasoning means in an LLM and what changes during inference.</span>
    ...
    <a class="s5-list-row" href="/en/temas/agentes-ia/">
      ...
      <span class="s5-list-row__desc">Goals, tools, state and boundaries for moving from answering to acting.</span>
    ...
    <a class="s5-list-row" href="/en/temas/prompt-injection/">
      ...
      <span class="s5-list-row__desc">Why data can influence instructions and how to reduce that risk.</span>
...
<section class="s5-section">
  <div class="s5-section-head">
    ...
    <a href="/en/visuales/">View all →</a>
  </div>
  <div class="s5-media-stack">
    <a class="s5-media-card" href="/en/videos/series/multimodalidad-iag/03-arquitecturas/">
      <img class="s5-media-card__image" src="/en/series/multimodalidad-iag/03-arquitecturas.jpg" alt="Visual about multimodal architectures" />
      <div class="s5-media-card__meta">Video · Multimodality</div>
      <div class="s5-media-card__title">How multimodal models are built</div>
    </a>
    <a class="s5-media-card" href="/en/videos/series/from-cave-to-agi/04-escalar/">
      <img class="s5-media-card__image" src="/en/series/from-cave-to-agi/04-escalar.jpg" alt="Visual about scaling AI models" />
...
<section class="s5-section">
  ...
  <div class="s5-simple-list">
    <a class="s5-list-row" href="/en/series/fundamentos-ia-iag/00_presentacion_serie/">
      <span class="s5-list-row__n">01</span>
      <span class="s5-list-row__title">AI Foundations</span>
    ...
    <a class="s5-list-row" href="/en/series/multimodalidad-iag/00_presentacion_serie/">
      ...
      <span class="s5-list-row__desc">Text, image, audio and video inside the same system.</span>
    ...
    <a class="s5-list-row" href="/en/series/modelos-razonadores/00_presentacion_serie/">
      ...
      <span class="s5-list-row__desc">Capability, failure modes, cost and latency in models that deliberate.</span>
      <span class="s5-list-row__meta">5 chapters</span>
    </a>
