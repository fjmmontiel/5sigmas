...
### 1. **Electricidad → bienestar (los mecanismos reales)**
   ...
   {{ include_html("snippets/series_energy_ai_01_electricity.html") }}
...
### 2. **IA como tecnología eléctrica**
   ...
   {{ include_html("snippets/series_energy_ai_02_ai.html") }}
...
### 3. **Medición: PIB vs bienestar (y qué mirar de verdad)**
   ...
   {{ include_html("snippets/series_energy_ai_03_measurement.html") }}
...
### 4. **IA y PIB hoy: impacto real, desfases y señales tempranas**
   ...
   {{ include_html("snippets/series_energy_ai_04_gdp.html") }}
