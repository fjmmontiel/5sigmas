...
La novedad de 2026 es que la unidad de análisis está empezando a moverse desde el "copilot puntual" hacia el agente que ejecuta trabajo más largo. OpenAI estima, a partir de una muestra de usuarios individuales de Codex, que en mayo de 2026 el 80,6% había realizado al menos una petición equivalente a más de 30 minutos de trabajo humano, el 70,2% al menos una petición de más de una hora y el 25,6% al menos una petición de más de ocho horas [OpenAI (2026)](https://openai.com/index/how-agents-are-transforming-work/). La medición no es una encuesta clásica de productividad: OpenAI estima la duración humana de la tarea mediante un juez de IA sobre una muestra pequeña, pero el dato sí apunta a un cambio relevante en la forma de usar estas herramientas.

Anthropic reporta una señal parecida desde dentro de su propia organización. En su informe sobre uso interno de Claude, los empleados declararon ganancias medias de productividad cercanas al 50%, y la compañía afirma que las PRs fusionadas por ingeniero y día aumentaron un 67% tras adoptar Claude Code [Anthropic (2026)](https://www.anthropic.com/research/how-ai-is-transforming-work-at-anthropic). Es una fuente interna y autorreportada, por tanto no debe leerse como un efecto universal. Pero es útil porque mide el paso de "ayuda en una tarea" a "cambio operativo en un equipo".

Esas ganancias a nivel de tarea, sesión o equipo no producen automáticamente el mismo porcentaje de ganancia a nivel de empresa o de economía, porque el tiempo ahorrado no siempre se redirige a tareas más productivas. La evidencia más honesta hoy no dice que el PIB vaya a saltar mañana: dice que ya hay trabajo concreto que se está haciendo más rápido, con más delegación y con unidades de tarea cada vez más largas.
...
En tareas específicas y medibles. Las ganancias más documentadas son del 20-50% en tareas de codificación (GitHub Copilot: +26% en tasa de completitud), entre el 12 y el 32% en tareas legales, y +14% en casos resueltos por hora en atención al cliente (Brynjolfsson et al., 2023). En 2026, la evidencia abierta sobre agentes de código añade otra señal: OpenAI estima que una parte significativa del uso de Codex ya corresponde a tareas equivalentes a más de una hora humana, y Anthropic reporta internamente más productividad y más PRs fusionadas tras adoptar Claude Code. En ciencia, AlphaFold aceleró la predicción de estructuras proteicas en un factor de 45.000. En manufactura, los primeros sistemas de optimización en tiempo real muestran reducciones del 2-5% en consumo energético de instalaciones industriales. Estas ganancias a nivel de tarea, sesión o equipo no siempre escalan automáticamente a nivel de empresa o de economía.
...
| R9 | **OpenAI (2026)** — *How agents are transforming work* ([OpenAI][r9]) | Informe sobre uso de Codex: estima tareas equivalentes a más de 30 minutos, más de una hora y más de ocho horas de trabajo humano. Útil como señal de delegación de tareas largas, no como medida directa de productividad agregada. |
| R10 | **Anthropic (2026)** — *How AI is transforming work at Anthropic* ([Anthropic][r10]) | Informe interno sobre uso de Claude y Claude Code: productividad autorreportada, nuevas tareas habilitadas y aumento de PRs fusionadas por ingeniero y día tras adoptar Claude Code. |
| R11 | **METR (2026)** — *Update on measuring AI productivity uplift* ([METR][r11]) | Evidencia cautelar sobre medición de productividad en desarrollo de software: muestra lo difícil que es convertir uso de herramientas en estimaciones limpias de productividad causal. |
