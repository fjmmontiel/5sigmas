...
!!! info "Prerrequisitos"
    Este capítulo cierra la serie. Asume que has leído los tres capítulos anteriores: [Capítulo 1 — Qué es IA](./01-que-es-ia.md), [Capítulo 2 — Qué es IA Generativa](./02-que-es-ia-generativa.md) y [Capítulo 3 — IA vs IA Generativa](./03-ia-vs-ia-generativa.md).
