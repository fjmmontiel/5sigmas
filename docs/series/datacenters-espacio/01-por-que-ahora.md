...
La cantidad de cómputo usada para entrenar modelos de vanguardia ha aumentado unas *350.000* veces desde 2014, según la Agencia Internacional de la Energía ([IEA][r1]). En paralelo, la IEA estimó en 2024 que el consumo eléctrico agregado de centros de datos, IA y criptomonedas podía pasar de 460 TWh en 2022 a más de 1.000 TWh en 2026, una escala comparable al consumo total de Japón ([IEA][r2]). En su informe posterior sobre energía e IA, la predicción base para centros de datos se sitúa en 945 TWh para 2030 si los factores de eficiencia se comportan como se espera, y podría superar los 1.260 TWh si la adopción de la IA acelera más de lo previsto ([IEA][r1]).
