---
title: Próximamente
description: Temas en investigación para futuras series y notas de 5sigmas.
robots: noindex
hide:
  - toc
  - navigation
...
<section class="s5-page-intro">
  <div class="s5-eyebrow">En investigación</div>
  <h1>Lo siguiente.</h1>
  <p>Temas que están siendo estudiados. El orden indica continuidad editorial, no una fecha de publicación comprometida.</p>
</section>
...
<section class="s5-section">
  <div class="s5-simple-list">
    <div class="s5-list-row">
      ...
      <span class="s5-list-row__desc">Benchmarks frente a rendimiento real, LLM-as-judge y red-teaming.</span>
      <span class="s5-list-row__meta">Investigación</span>
    </div>
    <div class="s5-list-row">
      <span class="s5-list-row__n">02</span>
      <span class="s5-list-row__title">RAG</span>
      <span class="s5-list-row__desc">Arquitectura, recuperación, evaluación y límites del grounding.</span>
      <span class="s5-list-row__meta">Investigación</span>
    </div>
    <div class="s5-list-row">
...
<section class="s5-section">
  <a class="s5-text-link" href="/series/">Ver las series publicadas →</a>
</section>
