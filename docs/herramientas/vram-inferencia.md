...
<section class="s5-tool-method" aria-labelledby="s5-vram-method">
  ...
  <div class="s5-tool-method__body">
    ...
    <p class="s5-tool-method__notes"><strong>Cobertura Llama 4.</strong> Scout (17B activos/109B totales, 16 expertos, 10M de contexto) y Maverick (17B activos/400B totales, 128 expertos, 1M) están revisados contra el model card de Meta, pero no se convierten en presets: son MoE y las fuentes primarias actuales no exponen toda la geometría necesaria para esta fórmula sin introducir supuestos no publicados.</p>
