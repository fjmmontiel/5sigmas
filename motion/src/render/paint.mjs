...
export class Paint {
  constructor(ctx,theme,issues=[],locale='es',labels={}) {this.c=ctx;this.T=theme;this.issues=issues;this.locale=locale;this.labels={...labels};}
  l(key){return this.labels[key] ?? key;}
