...
check(/no es una prueba de «dataset limpio»/i.test(esPlain), 'ES: overlap scan must not certify cleanliness');
check(/(?:is|it is) not (?:a )?proof of a? ?["“]?clean dataset["”]?/i.test(enPlain), 'EN: overlap scan must not certify cleanliness');
