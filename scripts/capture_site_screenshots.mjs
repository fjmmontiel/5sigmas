...
const validateReader = async (page, viewport) => {
  ...
  if (reader.seriesTabs !== 8 || reader.panels !== 8) {
    throw new Error(`expected 8 collections in the searchable library, found ${reader.seriesTabs}/${reader.panels}`);
  }
  ...
  if (reader.directCollections !== 8 || reader.directEntries < 30 || reader.currentDirectEntries !== 1) {
