#!/usr/bin/env python3
"""Current-owner MEDIA_VISUAL evidence gate for the agentes-ia series.
...
ARTICLES = (
    ...
    "01-que-es-un-agente.md",
    "02-anatomia-de-un-agente.md",
    "03-como-evaluar-un-agente.md",
    "04-seguridad-agentes.md",
    "05-de-la-demo-a-produccion.md",
)
...
def self_test() -> None:
    ...
    print("PASS Agents MEDIA_VISUAL/VOICE split + exact-video visual sampling fixture")
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("artifacts/agents-requalification/agents-media-visual.json"),
    )
    ...
    try:
        ...
        print(f"AGENTS_MEDIA_CONFIG_ERROR: {exc}", file=sys.stderr)
        return 2
