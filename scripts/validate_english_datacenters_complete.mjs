...
const contracts = {
  ...
  '04-huella-real-datacenter': {
    ...
    hooks:[['h2','1. The comparison that calibrates the conversation','.dac[data-demo="dc-04-water-scale"]','p','This comparison is not meant'],['p','Microsoft\'s Iowa design','.dwr[data-demo="dc-04-wue"]','p','AI has added a new dimension'],['p','If a facility delivers 1 MWh','.dai[data-demo="dc-04-indirect-water"]','p','The industry is reducing its reliance'],['h2','3. Energy: the AI premium and what it implies','.dsc[data-demo="dc-04-sector-power"]','p','The metric that measures'],['p','The metric that measures the energy efficiency','.dpt[data-demo="dc-04-pue"]','p','What AI has changed'],['p','Nvidia\'s GB200 NVL72 rack','.ded[data-demo="dc-04-rack-density"]','p','This increase in rack density'],['p','91 percent concentrated in China','.dmc[data-demo="dc-04-minerals"]','p','Cobalt is the best-documented'],['p','Seventy-two percent of residents','.dcc[data-demo="dc-04-cobalt"]','p','The technology industry has launched initiatives'],['p','Microsoft reported in 2024','.dhr[data-demo="dc-04-gpu-recovery"]','p','At the scale of tens or hundreds of thousands']],
