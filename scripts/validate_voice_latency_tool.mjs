...
for (const spec of cases) {
  for (const viewport of viewports) {
    ...
    for (const expected of ['developers.openai.com/api/docs/models/gpt-live-1', 'developers.deepgram.com/docs/endpointing', 'elevenlabs.io/docs/developer-guides/reducing-latency', 'twilio.com/docs/voice/media-streams/websocket-messages', 'PMC2705608']) {
