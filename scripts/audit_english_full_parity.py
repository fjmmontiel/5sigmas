...
def main() -> int:
    ...
    expected_nav = {path for path in nav_paths(es_cfg) if (DOCS / path).is_file()}
    # videos/index.md is generated by the Spanish video hook and therefore has
    # no source file. It is represented by the generated-video-surface metric.
