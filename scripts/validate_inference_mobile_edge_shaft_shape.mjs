...
console.log('PASS: compressed-SVG/V/direct/degenerate/boundary-hidden/tiny-shaft mutations fail; every mobile edge overlay fully covers its graph; every routed short edge has a node-clear orthogonal shaft >=8 SVG units across 12 ES/EN routes in normal/reduced motion.');