#!/usr/bin/env python3
"""Fail-closed INDEXABILITY gate for Evaluating AI Systems article + watch surfaces.
...
def self_test() -> None:
    configure()
    first_es = (
        "https://5sigmas.com/series/evaluating-ai-systems-production/"
        "01-que-evaluar-modelo-componente-sistema-workflow-trayectoria/"
    )
    last_en_watch = (
        "https://5sigmas.com/en/videos/series/evaluating-ai-systems-production/"
        "06-observability-failure-taxonomies-production-eval-repair-feedback-loops/"
    )
    ...
    mutations = (
        ...
        (
            good.replace(
                "/series/evaluating-ai-systems-production/01-que-evaluar-modelo-componente-sistema-workflow-trayectoria/",
                "/en/series/evaluating-ai-systems-production/01-que-evaluar-modelo-componente-sistema-workflow-trayectoria/",
            ),
            "canonical",
        ),
    ...
    hreflang_fixture = {
        first_es: {
            "en": (
                "https://5sigmas.com/en/series/evaluating-ai-systems-production/"
                "01-que-evaluar-modelo-componente-sistema-workflow-trayectoria/"
            )
        }
    }
    ...
    print(
        "Evaluating AI Systems INDEXABILITY negative fixtures passed: "
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("artifacts/evaluating-ai-systems-requalification/indexability/report.json"),
    )
