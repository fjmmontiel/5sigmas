...
console.log('Context Engineering release-surface QA PASS: ES/EN Series hubs expose the series among 12 canonical rows, all 12 chapter routes load without broken same-origin resources, locale switching and six-chapter reader progression remain exact, and desktop/mobile page geometry is clean.');
